            ...
            if open_sl=='long':
                ...
                if current_price<stop_price:
                    ...
                    for j in range(0,len(temp_arr)-1):
                        ...
                        # take profit
                            close_position(symbol,'long',abs(round(maxposition*(contracts/2),3)))
                            del proffit_array[0]
            ...
            if open_sl=='short':
                ...
                if current_price>stop_price:
                    ...
                    for j in range(0,len(temp_arr)-1):
                        ...
                        if(current_price<(entry_price-delta)):
                        # take profit
                            close_position(symbol,'short',abs(round(maxposition*(contracts/2),3)))
                            del proffit_array[0]
...
while time.time() <= timeout:
    try:
        ...
        if counterr>5:
            counterr=1
        time.sleep(60 - ((time.time() - starttime) % 10.0)) # 1 minute interval between each new execution
